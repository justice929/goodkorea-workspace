      ...
      <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap:20px">
        ${e.map(e=>`
          <div class="platform-conn-card" style="background:rgba(15,23,42,0.5); padding:24px; border-radius:20px; border: 1px solid rgba(255,255,255,0.05); transition: all 0.3s">
            ...
            <button class="btn-sm btn-orange" style="width:100%; border-radius:10px; font-size:12px" onclick="(window as any).handleSavePlatform('${e}')">설정 저장하기</button>
          </div>
        `).join(``)}
      </div>
